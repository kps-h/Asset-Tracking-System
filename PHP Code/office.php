...
// Handle AJAX: Check for duplicate key
if (isset($_POST['check_duplicate_key'])) {
    $key = $_POST['key'];

    $stmt = $conn->prepare("SELECT COUNT(*) FROM office_keys WHERE `key` = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['key'])) {
    ...
    $sql = "INSERT INTO office_keys (`key`, vendor, original_or_pirated, purchase_date, validity, remarks) 
            VALUES (?, ?, ?, ?, ?, ?)";
...
<head>
    ...
    <title>Office Key Information Form</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Office Key</h2>
    <form method="POST" id="officeKeyForm" novalidate>
        <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to submit this Office Key?
            </div>
...
<script>
    ...
    // Check for duplicate Office Key
    ...
    document.getElementById('submitBtn').addEventListener('click', () => {
        const form = document.getElementById('officeKeyForm');
    ...
    document.getElementById('confirmSubmit').addEventListener('click', () => {
        ...
        .then(() => {
            ...
            showPopup("✅ <strong>Office Key</strong> successfully created!");
        })
        .catch(() => {
