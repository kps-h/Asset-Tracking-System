...
$sql = "SELECT * FROM anti_defection";
...
<div class="container py-5">
    <h2 class="mb-4">Anti Defection Report</h2>
    <table id="antiDefectionTable" class="table table-bordered table-hover">
