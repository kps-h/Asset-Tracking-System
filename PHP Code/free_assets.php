...
$conn = mysqli_connect("localhost", "your_user", "your_pass", "track");

// Fetch asset data for 'free' assets along with related key data from the database
$query = "
    ...
    WHERE ar.status = 'free'  -- Only get 'free' assets
...
<style>
        ...
        thead {
            background-color: red !important; /* Force red background for the table header */
        }

        th {
            color: white !important;  /* Set the text color of headers to white */
        }
    </style>
</head>
<body>
